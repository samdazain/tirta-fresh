                        ...
                        <div className="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer disabled:cursor-not-allowed"
                                    disabled={loading}
                                >
